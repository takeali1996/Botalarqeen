...
ws[6] = "ماحب قففلامير" -- msg 
rs[6] = "هسه اكله الامير عليhiser ⚠️ " -- reply
...
ws[21] = "اي الففلفيف" -- msg 
rs[21] = "روحلهم خالفلفلفقف" -- reply
...
ws[72] = "الال5ل56وامر" -- msg 
rs[72] ="لظهار لاوامر دز مساعدة😍❤️️"

ws[73] = "helpل5" -- msg 
rs[73] ="لظهار الال5ل5وامر دز مساعدة😍❤️️"
...
ws[187] = "heee3elp" -- msg 
rs[187] ="لظهار الe3اوامر دز مساعدة😍❤️️"

ws[188] = "اريد سورس" -- msg 
rs[188] ="منطي لجهال 😍❤️️"
...
if ( msg.from.username == "taqe" ) then
R = get_receiver(msg)
send_large_msg ( R , "Made by @tq_qt" );
end
end 

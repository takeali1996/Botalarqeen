...
local function check_member_super(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
	  local text = 'ت(✔️)م اضافة البوت في المجمو(👥)عة'..msg.to.title
...
local function check_member_superrem(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
      local text = 'ت(✖️)م تعطيل البوت في المجمو(👥)عة'..msg.to.title
      return reply_msg(msg.id, text, ok_cb, false)
    end
  end
end
...
local function lock_group_links(msg, data, target)
  ...
  if group_link_lock == 'yes' then
    return 'ان الراوبط مقفلا بلفعل في المجموعه✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
...
local function unlock_group_links(msg, data, target)
  ...
  if group_link_lock == 'no' then
    return 'الروابط بلفعل مفتوحه في المجموعه 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
...
local function lock_group_all(msg, data, target)
  ...
  if group_all_lock == 'yes' then
    return 'كل الاعضاء مقفل بلفعل في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['all'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تم قفل الكل الاعضاء عن الكلام في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_all(msg, data, target)
  ...
  if group_all_lock == 'no' then
    return 'كتم الاعضاء بلفعل مفتوح في المجموعه 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['all'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم فتح كل الاعضاء في المجموعه 🔓\n👮 ياعزيزي :️ @'..msg.from.username
...
local function lock_group_leave(msg, data, target)
  ...
  if group_leave_lock == 'yes' then
    return 'ان المغادرا بلفعل مقفلا في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['leave'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تم قفل المغادرا في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_leave(msg, data, target)
  ...
  if group_leave_lock == 'no' then
    return 'المغادرا بلفعل مفتوحه في المجموعه 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['leave'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم فتح المغادرا في المجموعه 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function lock_group_operator(msg, data, target)
  ...
  if group_operator_lock == 'yes' then
    return 'العامل مقفول بلفعل في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['operator'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تم قفل العامل في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_operator(msg, data, target)
  ...
  if group_operator_lock == 'no' then
    return 'العامل بلفعل مفتوح في المجموعه 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['operator'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم فتح العامل في المجموعه 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function lock_group_reply(msg, data, target)
  ...
  if group_reply_lock == 'yes' then
    return 'الردود بلفعل مقفوله في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['reply'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تم قفل الردود في المجموعه  ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_reply(msg, data, target)
  ...
  if group_reply_lock == 'no' then
    return 'الردود بلفعل مفتوحات في المجموعه 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['reply'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم فتح الردود في المجموعه 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function lock_group_username(msg, data, target)
  ...
  if group_username_lock == 'yes' then
    return 'اليوزرنيم بلفعل مقفول في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['username'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تم قفل اليوزنيم في المجموعه ✅🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_username(msg, data, target)
  ...
  if group_username_lock == 'no' then
    return 'اليوزرنيم مفتوح في المجموعه 🔓\n���� ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['username'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم فتح اليوزرنيم في المجموعه 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function lock_group_media(msg, data, target)
  ...
  if group_media_lock == 'yes' then
    return 'الوسائط بلفعل مقفله في المجموعه ✅ء 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['media'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تم قفل الوسائط في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_media(msg, data, target)
  ...
  if group_media_lock == 'no' then
    return 'الوسائط بلفعل مفتوحه في المجموعه 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['media'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم قتح الوسائط في المجموعه 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function lock_group_fosh(msg, data, target)
  ...
  if group_fosh_lock == 'yes' then
    return 'الكلمات السيء بلفعل مقفوله في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['fosh'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تم قفل الكلمات السيء في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_fosh(msg, data, target)
  ...
  if group_fosh_lock == 'no' then
    return 'الكلمات السيء مفتوحات في المجموعه ❎🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['fosh'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم فتح الكلمات السيء في المجموعه❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function lock_group_join(msg, data, target)
  ...
  if group_join_lock == 'yes' then
    return '✅الدخول عبر الرابط مفعل في المجموعه 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['join'] = 'yes'
    save_data(_config.moderation.data, data)
    return '✅ تم قفل الدخول عبر الرابط في المجموعه 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_join(msg, data, target)
  ...
  if group_join_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return '❎تم فتح الدخول عبر الرابط في المجموعه 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function lock_group_fwd(msg, data, target)
  ...
  if group_fwd_lock == 'yes' then
    return '✅اعاده التوجيه مفعل في المجموعه 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
...
local function unlock_group_fwd(msg, data, target)
  ...
  if group_fwd_lock == 'no' then
    return 'اعاده التوجيه بلفعل مفتوح في المجموعه ❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
...
local function lock_group_english(msg, data, target)
  ...
  if group_english_lock == 'yes' then
    return 'اللغه النكليزيه مقفوله في المجموعه✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['english'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تم قفل اللغه النكليزية في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_english(msg, data, target)
  ...
  if group_english_lock == 'no' then
    return 'اللغه النكليزيه مفتوحه في المجموعه 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['english'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم فتح اللغه النكليزيه في المجموعه❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function lock_group_emoji(msg, data, target)
  ...
  if group_emoji_lock == 'yes' then
    return 'السمايلات مقفوله في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['emoji'] = 'yes'
    save_data(_config.moderation.data, data)
    return '✅تم قفل السمايلات في المجموعه 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_emoji(msg, data, target)
  ...
  if group_emoji_lock == 'no' then
    return 'السمايلات مفتوحه في المجموعه❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['emoji'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم فتح المايلات في المجموعه  ❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function lock_group_tag(msg, data, target)
  ...
  if group_tag_lock == 'yes' then
    return 'الشارة او التاك مقفول في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['tag'] = 'yes'
    save_data(_config.moderation.data, data)
    return '✅تم قفل الشارة او التاك في المجموعه 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_tag(msg, data, target)
  ...
  if group_tag_lock == 'no' then
    return 'التاك او الشارة مفتوحات في المجموعه ❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['tag'] = 'no'
    save_data(_config.moderation.data, data)
    return 'فتح الشارة او التاك في المجموعه ❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_all(msg, data, target)
  ...
  local group_all_lock = data[tostring(target)]['settings']['all']
  if group_all_lock == 'no' then
    return 'الكتم بلفعل مفعل في المجموعه 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['all'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم فتح الكتم في المجموعة 🔓\n👮 ياعزيزي : @'..msg.from.username
  end
end
...
local function lock_group_spam(msg, data, target)
  ...
  if group_spam_lock == 'yes' then
    return 'السبام بلفعل مقفول في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['lock_spam'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تم قفل السبام في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_spam(msg, data, target)
  ...
  if group_spam_lock == 'no' then
    return 'السبام بلفعل مفتوح في المجموعه ❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['lock_spam'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم فتح السبام في المجموعه ❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function lock_group_flood(msg, data, target)
  ...
  if group_flood_lock == 'yes' then
    return 'التكرار بلفعل مقفول في المجموعه✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['flood'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تم قفل التكرار في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_flood(msg, data, target)
  ...
  if group_flood_lock == 'no' then
    return 'التكرار بلفعل مفتوح في المجموعه ❎ 🔓\n👮ياعزيزي '..msg.from.username
  else
...
local function lock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == 'yes' then
    return 'اللغه العربيه بلفعل مقفوله في المجموعه ✅🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['lock_arabic'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تم قفل اللغه العربيه في المجموعه ✅🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == 'no' then
    return 'اللغه العربيه مفتوحه في المجموعه ❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['lock_arabic'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم فتح اللغه العربيه في المجموعه ❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function lock_group_membermod(msg, data, target)
  ...
  return 'الاضافه مقفول في المجموعه✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['lock_member'] = 'yes'
    save_data(_config.moderation.data, data)
  end
    return 'تم قفل الاضافه في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
end
...
local function unlock_group_membermod(msg, data, target)
  ...
  if group_member_lock == 'no' then
    return 'الاضافه مفعل في المجموعه ❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['lock_member'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم فتح الاضافه في المجموعه❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function lock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == 'yes' then
    return 'الرتل بلفعل مقفول في المجموعه 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['lock_rtl'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تم قفل الرتل في المجموعه 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == 'no' then
    return 'الرتل بلفعل مفتوح في المجموعه 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['lock_rtl'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم فتح الرتل في المجموعه 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function lock_group_tgservice(msg, data, target)
  ...
  if group_tgservice_lock == 'yes' then
    return 'الاشعارات الدخول بلفعل مقفول في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['lock_tgservice'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تم قفل الاشعارات الدخول في المجموعه✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_tgservice(msg, data, target)
  ...
  if group_tgservice_lock == 'no' then
    return 'الاشعارات الدخول بلفعل مفتوح في المجموعه ❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['lock_tgservice'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم فتح الاشعارات الدخول في المجموعه ❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function lock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == 'yes' then
    return 'الملصقات بلفعل مقفولات في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['lock_sticker'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تم قفل الملصقات في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == 'no' then
    return 'الملصقات  بلفعل مفتوحات في المجموعه❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['lock_sticker'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم فتح الملصقات في المجموعه ❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function lock_group_bots(msg, data, target)
  ...
  if group_bots_lock == 'yes' then
    return 'البوتات بلفعل مقفلات في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['lock_bots'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تم قفل البوتات في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_bots(msg, data, target)
  ...
  if group_bots_lock == 'no' then
    return 'البوتات بلفعل مفتوحات في المجموعه ❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['lock_bots'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم الفتح البوتات في المجموعه ❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function lock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == 'yes' then
    return 'الاجهات الاتصال مقفله بلفعل في المجموعه ✅ ��\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['lock_contacts'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تم قفل الاجهات الاتصال في المجموعه ✅ 🔐\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function unlock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == 'no' then
    return 'الاجهات الاتصال بلفعل مفتوحه في االمجموعه❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['lock_contacts'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم فتح الاجهات الاتصال في المجموعه ❎ 🔓\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function enable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == 'yes' then
    return 'الحماية مقفله بلفعل في المجموعه ✅ 🛡\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['strict'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تم قفل الحماية في المجموعه✅ 🛡\n👮 ياعزيزي :️ @'..msg.from.username
  end
end
...
local function disable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == 'no' then
    return 'الحماية مفتوحه بلفعل في المجموعه 🛡\n👮 ياعزيزي :️ @'..msg.from.username
  else
    data[tostring(target)]['settings']['strict'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تم فتح الحماية في المجموعه ❎🛡\n👮  ياعزيزي @'..msg.from.username
  end
end
...
local function set_public_membermod(msg, data, target)
  if not is_momod(msg) then
    return "❌ لايمكن للاعضاء ان يستخدمون هذه الاومر  ❌"
  end
  ...
  if group_public_lock == 'yes' then
    return '❌  المجموعه غير العامة بالفعل 🗣'
  else
...
local function promote2(receiver, member_username, user_id)
  ...
  if data[group]['moderators'][tostring(user_id)] then
    return send_large_msg(receiver, member_username..' ✔️ تم رفع ادمن في المجموعه ✔️')
  end
  data[group]['moderators'][tostring(user_id)] = member_tag_username
  save_data(_config.moderation.data, data)
  send_large_msg(receiver, member_username.. ' ✔️ تم رفع ادمن في المجموعه ✔️')
end
...
local function demote2(receiver, member_username, user_id)
  ...
  data[group]['moderators'][tostring(user_id)] = nil
  save_data(_config.moderation.data, data)
  send_large_msg(receiver, member_username..' ❌ تم تنزيل من الادمنية في المجموعه ❌')
end
...
function get_message_callback(extra, success, result)
	...
	elseif get_cmd == "demoteadmin" then
		...
		if is_admin2(result.from.peer_id) then
			return send_large_msg(channel_id, "❌ لايمكنك ان تنزيل هذه العضو ❌ !")
		end
	...
	elseif get_cmd == "setowner" then
		...
		local channel_id = 'channel#id'..result.to.peer_id
			...
			if result.from.username then
				text = "@"..result.from.username.." [ "..result.from.peer_id.." ] ✔️ تم رفع مدير/ة في المجموعه ✔️"
			else
				text = "[ "..result.from.peer_id.." ] ✔️ تم رفع مدير/ة في المجموعه ✔️"
			end
			send_large_msg(channel_id, text)
		end
	...
	for k,v in pairs(result) do
		...
		if vusername == member or vpeer_id == memberid then
			...
			if group_owner then
				...
				if result.username then
					text = member_username.." ["..v.peer_id.."] ✔️ تم رفع مدير/ة في المجموعه ✔️"
				else
					text = "["..v.peer_id.."] ✔️ تم رفع مدير/ة في المجموعه ✔️"
				end
			end
		elseif memberid and vusername ~= member and vpeer_id ~= memberid then
			...
			if group_owner then
				...
				text = "["..memberid.."] ✔️ تم رفع مدير/ة في المجموعه ✔️"
			end
		end
	end
 end
...
local function DevPointTeam(msg, matches)
	...
	local name_log = print_name:gsub("_", " ")
	local data = load_data(_config.moderation.data)
			if matches[1] == 'start' and not matches[2] then
			if not is_admin1(msg) and not is_support(support_id) then
				return
			end
			if is_super_group(msg) then
		  local iDev1 = 'تم تفعيل المجموعه بنجاح ✅\n👮ياعزيزي :️ @'..msg.from.username
		...
		if matches[1] == 'start' and is_admin1(msg) and not matches[2] then
			if not is_super_group(msg) then
			  local iDev1 = "هذه المجموعة يقم بإضافة 🤖 موافق وأود أن أضيف هذا كروب"
			  return send_large_msg(receiver, iDev1)
			end
		...
		if matches[1] == 'stop' and is_admin1(msg) and not matches[2] then
			if not is_super_group(msg) then
				return reply_msg(msg.id, 'تم تعطـيل المجموعه ❎ \n 👮ياعزيزي :️ @'..msg.from.username, ok_cb, false)
			end
			print("SuperGroup "..msg.to.print_name.."("..msg.to.id..") removed")
			superrem(msg)
			rem_mutes(msg.to.id)
		...
		if matches[1] == 'ban' or matches[1] == 'kick' and is_momod(msg) then
			if type(msg.reply_id) ~= "nil" then
				local cbreply_extra = {
				...
				get_message(msg.reply_id, get_message_callback, cbreply_extra)
			elseif matches[1] == 'ban' or matches[1] == 'kick' and string.match(matches[2], '^%d+$') then
		...
		if matches[1] == 'newlink' and is_momod(msg)then
			...
			local receiver = get_receiver(msg)
				if success == 0 then
					...
					send_large_msg(receiver, "تم تغير رابط المجموعه بنجاح ✔️")
		...
		if matches[1] == 'setlink' and is_owner(msg) then
			...
			save_data(_config.moderation.data, data)
			return 'يرجى إرسال رابط مجموعة جديدة الآن'
		end
		...
		if msg.text then
			if msg.text:match("^(https://telegram.me/joinchat/%S+)$") and data[tostring(msg.to.id)]['settings']['set_link'] == 'waiting' and is_owner(msg) then
				...
				save_data(_config.moderation.data, data)
				return "تم تغير رابط المجموعه بنجاح ✔️"
			end
		end
		...
		if matches[1] == 'link' then
			...
			if not group_link then
				return "/newlink لتغير رابط المجموعة 📡\n /setlink لوضع رابط للمجموعة 🔎"
			end
			savelog(msg.to.id, name_log.." ["..msg.from.id.."] requested group link ["..group_link.."]")
			return "رابط المجموعة ⚠️ ["..msg.to.title.."] :\n"..group_link
		end
		...
		if matches[1] == 'sphoto' and is_momod(msg) then
			...
			return 'الان ارسل الصوره لوضع للمجموعه ✔️'
		end
		...
		if matches[1] == 'on' and is_momod(msg) then
			local target = msg.to.id
		...
		if matches[1] == 'off' and is_momod(msg) then
			local target = msg.to.id
			     if matches[2] == 'all' then
      	local dsafemode ={
        unlock_group_links(msg, data, target),
		...
		if matches[1] == 'sflood' then
			...
			if tonumber(matches[2]) < 5 or tonumber(matches[3]) > 25 then
				return "تم وضع التكرار ✅: (3:25)"
			end
		...
		if matches[1] == 'on' and is_owner(msg) then
			local chat_id = msg.to.id
			...
			local msg_type = 'Audio'
				if not is_muted(chat_id, msg_type..': yes') then
					...
					mute(chat_id, msg_type)
					    return 'تم قفل الصوتيات في المجموعه ✅ 🎵🔐\n👮 ياعزيزي :️ @'..msg.from.username
				else
					    return 'الصوتيات مقفلا في المجموعه ✅ 🎵🔐\n👮 ياعزيزي :️ @'..msg.from.username
				end
			end
			...
			local msg_type = 'Photo'
				if not is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
					mute(chat_id, msg_type)
					return ' تم قفل الصور في المجموعه✅ 🎡🔐\n👮 ياعزيزي :️ @'..msg.from.username
				else
					return 'الصور مقفلا في المجموعه✅ 🎡🔐\n👮 ياعزيزي :️ @'..msg.from.username
				end
			end
			...
			local msg_type = 'Video'
				if not is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
					mute(chat_id, msg_type)
					return 'تم قفل الفيديوهات في المجموعه ✅ 🎥🔐\n👮 ياعزيزي :️ @'..msg.from.username
				else
					return 'الفيديوهات مقفلا بلفعل في المجموعه ✅ 🎥🔐\n👮 ياعزيزي :️ @'..msg.from.username
				end
			end
			...
			local msg_type = 'Gifs'
				if not is_muted(chat_id, msg_type..': yes') then
					...
					return 'الملصقات مقفلا بلفعل في المجموعه ✅ 🎆🔐\n👮 ياعزيزي :️ @'..msg.from.username
				end
			end
			...
			local msg_type = 'Documents'
				if not is_muted(chat_id, msg_type..': yes') then
					...
					return 'الملفــات مقفلا بلفعل في المجموعه 📂🔐\n👮 ياعزيزي :️ @'..msg.from.username
				end
			end
			...
			local msg_type = 'Text'
				if not is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
					mute(chat_id, msg_type)
					return 'تم قفل النص الكلام في المجموعه ✅ 📝🔐\n👮 ياعزيزي :️ @'..msg.from.username
				else
					return 'النص الكلام مقفل في المجموعه 📝🔐\n👮 ياعزيزي :️ @'..msg.from.username
				end
			end
			if matches[2] == 'all' then
			local msg_type = 'All'
				if not is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
					mute(chat_id, msg_type)
					return 'تم قفل الكل في المجموعه ✅ 🔕\n👮ياعزيزي :️ @'..msg.from.username
				else
					return ' كل الاعضاء مقفلا بلفعل في المجموعه ✅🔕\n👮 ياعزيزي :️ @'..msg.from.username
				end
			end
		end
		if matches[1] == 'off' and is_momod(msg) then
			...
			local msg_type = 'Audio'
				if is_muted(chat_id, msg_type..': yes') then
					...
					return 'تم فتح الصوتيات في المجموعه ❎ 🎵🔓\n👮 ياعزيزي :️ @'..msg.from.username
				else
					return 'الصوتيات مفتوحه بلفعل في المجموعه ❎ 🎵🔓\n👮 ياعزيزي :️ @'..msg.from.username
				end
			end
			if matches[2] == 'photo' then
			local msg_type = 'Photo'
				if is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
					unmute(chat_id, msg_type)
					return 'تم فتح الصور في المجموعه ❎ 🎡🔓\n👮 ياعزيزي :️ @'..msg.from.username
				else
					return 'الصور بلفعل مفتوحه في المجموعه ❎ 🎡🔓\n👮 ياعزيزي :️ @'..msg.from.username
				end
			end
			if matches[2] == 'video' then
			local msg_type = 'Video'
				if is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
					unmute(chat_id, msg_type)
					return 'تم فتح الفيديوهات في المجموعه ❎ 🎥🔓\n👮 ياعزيزي️ @'..msg.from.username
				else
					return 'الفيديوهات بلفعل مفتوحه في المجموعه ❎ 🎥🔓\n👮 ياعزيزي :️ @'..msg.from.username
				end
			end
			if matches[2] == 'gifs' then
			local msg_type = 'Gifs'
				if is_muted(chat_id, msg_type..': yes') then
					...
					return 'الملصقات بلفعل مفتوحه في المجموعه ❎ 🎆🔓\n👮 ياعزيزي :️ @'..msg.from.username
				end
			end
			if matches[2] == 'documents' then
			local msg_type = 'Documents'
				if is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
					unmute(chat_id, msg_type)
					return 'تم فتح الملفات في المجموعه✅ 📂🔓\n👮 ياعزيزي :️ @'..msg.from.username
				else
					return 'االملفات مفتوحه بلفعل في المجموعه✅ 📂🔓\n👮 ياعزيزي :️ @'..msg.from.username
				end
			end
			if matches[2] == 'text' then
			local msg_type = 'Text'
				if is_muted(chat_id, msg_type..': yes') then
					...
					unmute(chat_id, msg_type)
					return 'تم فتح النص الكتابه في المجموعه ❎ 📝🔓\n👮 ياعزيزي :️ @'..msg.from.username
				else
					return 'النص الكتابه مفتوح بلفعل في المجموعه ❎ 🎥🔓\n👮 ياعزيزي :️ @'..msg.from.username
				end
			end
			if matches[2] == 'all' then
			local msg_type = 'All'
				if is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
					unmute(chat_id, msg_type)
					return 'تم فتح الكل في المجموعه ❎  🔔\n👮 ياعزيزي :️ @'..msg.from.username
				else
					return 'الكل بلفعل متفتوح في المجموعه ❎ 🔔\n👮 ياعزيزي :️ @'..msg.from.username
				end
			end
		end
